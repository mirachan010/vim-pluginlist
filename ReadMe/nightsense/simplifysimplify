...
<p>While vim themes can be installed manually (place <a href="https://github.com/nightsense/simplifysimplify/tree/master/colors">theme file</a> in <code class="highlighter-rouge">~/.vim/colors/</code>), a <strong>plugin helper</strong> is recommended.</p>
...
<p>To install simplifysimplify using vim-plug, add the following to the top of your <code class="highlighter-rouge">vimrc</code>:</p>
...
<p>To activate the simplifysimplify theme, add one of the following lines to your <code class="highlighter-rouge">vimrc</code>:</p>

<ul>
  <li><code class="highlighter-rouge">colorscheme simplifysimplify-light</code></li>
  <li><code class="highlighter-rouge">colorscheme simplifysimplify-dark</code></li>
</ul>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>let g:simplifysimplify_dark_CursorLineNr = 'off'
let g:simplifysimplify_light_CursorLineNr = 'off'
</code></pre></div></div>

<p>Disable the highlighted <strong>line number background</strong>:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>let g:simplifysimplify_dark_LineNr = 'off'
let g:simplifysimplify_light_LineNr = 'off'
</code></pre></div></div>

<h2 id="terminal-vim">terminal vim</h2>

<p>See the <a href="https://github.com/nightsense/nightshell">nightshell</a> repository, which allows simplifysimplify to be used in a variety of terminal applications.</p>

<h2 id="palette">palette</h2>

<p>simplifysimplify consists of 8 theme-distinct <strong>base colours</strong>, which are used for most interface elements, and 8 standard <strong>accent colours</strong> (common to the “nightsense theme family”) used for syntax highlighting.</p>
